...
class BiometricDailySummaryReportWizard(models.TransientModel):
    ...
    def action_print_pdf(self):
        return self.env.ref('cr_zkteco_biometric_integration.action_report_daily_summary').report_action(self)
    ...
    def get_report_data(self):
        ...
        all_employees = self.env['hr.employee'].search([('active', '=', True)], order='name asc')
