...
class PaymentTransaction(models.Model):
    ...
    def _process_notification_data(self, notification_data):
        ...
        amount = notification_data.get("amount") or notification_data.get(
            "ekashu_amount"
        )
        if amount:
        ...
        if notification_data.get("_ach_flow"):
            ...
            if response_code == "1":
                ...
                _logger.info(
                    "ACH transaction %s approved (id=%s).",
                    self.reference,
                    transaction_id,
                )
    ...
    def _send_payment_request(self):
        ...
        try:
            ...
            nmi_response = http_requests.post(
                provider._nmi_get_direct_post_url(), data=post_payload, timeout=30
            )
